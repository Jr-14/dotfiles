...
# Find path for go lang
export PATH=$PATH:/usr/local/go/bin

eval "$(starship init bash)"
. "$HOME/.cargo/env"

[ -f "/home/jr/.ghcup/env" ] && source "/home/jr/.ghcup/env" # ghcup-env

function up-dev-offertures {
    pushd ~/Offertures/infrastructure/docker > /dev/null;
    npm run compose-up-dev;
    popd > /dev/null;
}

function down-dev-offertures {
    pushd ~/Offertures/infrastructure/docker > /dev/null;
